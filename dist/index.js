...
var _user$project$Main$mainUpdate = F2(
	function (msg, model) {
		var _p0 = msg;
		return {
			ctor: '_Tuple2',
...
var _user$project$Main$emptyMain = {headline: 'hello'};
var _user$project$Main$MainModel = function (a) {
	return {headline: a};
};
var _user$project$Main$Headline = function (a) {
	return {ctor: 'Headline', _0: a};
};
